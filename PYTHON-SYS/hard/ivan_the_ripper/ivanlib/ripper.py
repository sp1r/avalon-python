...
2. Добавить возможность подгрузить словарь и подбирать хэши по словарю.
3. Добавить возможность указывать набор символов для брутфорса.
4. Добавить поддержку русского языка.
"""
__author__ = 'sp1r'
